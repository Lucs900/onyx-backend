...
- After income is known as W-2, self-employed, or both, Fox offers docs filtered by that profile (paystubs / W-2; tax returns / business docs; or both). Bubbles: `Upload now` / `Skip for now`. Do not ask for docs when income is missing, empty, Other, or unknown. Other continues to preparing / summary.
