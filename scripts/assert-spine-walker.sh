...
if [[ "${SPINE_WALKER_SKIP_LEFTOVERS:-}" != "1" ]]; then
  if leftover_wanted 5 || leftover_wanted 6 || leftover_wanted 9 || leftover_wanted 10 || leftover_wanted 11 || leftover_wanted 12 || leftover_wanted 13 || leftover_wanted 14 || leftover_wanted 15 || leftover_wanted 16 || leftover_wanted 17 || leftover_wanted 18; then
