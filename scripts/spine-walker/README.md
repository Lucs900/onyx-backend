...
37. HELOC 500/400/50 This one → W-2 → Yes → type Ying Lee → Use this writes Borrowers 2 / Borrower 2 Ying Lee. Ray income unchanged. Skip papers → Looks right → Proceed → Ask Fox. Skip on the name ask stays Borrowers 1 and does not invent Ying.
