...
1. 20 on a known price → down and loan write, Use this once. After funds, home-type chips are House · Condo · 2–4 · Skip.
...
7. Home-type chips House · Condo · 2–4 · Skip. 2–4 asks rent. Skip rent allowed.
...
26. Leftover smoke: Combes 1040 (`2025 1040 - Combes Allan and Renz.pdf`, 223,455 bytes) + gold File after Use this — QI $36,453 held, Tax return in, Form 1040 off Still useful, Return row year + name. Playwright skips if that PDF is missing. Founder paperclip remains the ACCEPT bar.
36. HELOC 500/400/50 This one → W-2 → Just me → Skip debts / W-2 / stub → These numbers look right? chips → Looks right → Proceed · Not yet · Upload more → Proceed → Ask Fox · Upload more · Request human. Typed looks right / proceed leave the same chips. Line stays $50,000 / $367. Empty composer after Looks right is FAIL.
37. HELOC 500/400/50 This one → W-2 → Yes → Skip on the name → Borrowers 1 · no Ying · no Borrower 2 → Skip papers → Looks right → Proceed → Ask Fox. Then Yes → type Ying Lee → Use this still writes Borrowers 2 / Borrower 2 Ying Lee. Next paper ask names whose. Finish chips hold. Line $50,000 / $367.
