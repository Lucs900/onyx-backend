# 13 — Form 1120-S entity return (founder gold)

Preview only. Suggested · not underwritten. Confirm before write.

No `Ho Soy Inc 2024 Tax returns 1120S.pdf` bytes in git, walker fixtures, or onyx-fixtures. Private drop pages are read-only proof. Do not commit them.
...
Cover / transmittal → **Form 8879-CORP** (≈p5) → **Form 1120-S** (≈p7) → federal **Schedule K-1** pages.
...
`23-1120s-2024-harbor-studio.pdf` and `24-1120s-2025-harbor-studio.pdf` are Harbor worksheets. Useful for classify / disclaimer / 1084-addback smoke.

**Not ACCEPT proof.** Do not substitute them for the founder paperclip.

Harbor worksheets may still say “line 21 ordinary.” On this real 1120-S, line 21 is deductions. Do not let that steal **$52,702**.
...
Commit PDF. 2023 packet. Personal 1040. LOE / gross-receipts. Combined W-2 + K-1 write. Live pricing. Design. Marketing. Merge.

Doctrine also lives in `lib/income/INCOME-BIBLE.md`.
